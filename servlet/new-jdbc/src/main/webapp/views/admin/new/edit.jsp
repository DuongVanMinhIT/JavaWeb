                ...
                <div class="col-xs-12">
                        ...
                        <form id="formSubmit">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="categoryCode" name="categoryCode">
                                        <c:if test="${empty model.categoryCode}">
                                            ...
                                            <c:forEach var="item" items="${categoryries}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="shortdecription" name="shortdecription" value="${model.shortdecription}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">                                 
                                    <textarea rows="" cols="" id="content" name="content" style="width: 995px; height: 199px;">${model.content}</textarea>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            ...
                            <input type="hidden" value="${moel.id}" id="id" name="id"/>
                        </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#btnAddOrUpdateNew').click(function (e) {
        ...
        data["content"] = editor.getData();//get gia tu ckediter 
        var id = $('#id').val();
        if (id == 0) {
            addNew(data);
        } else {
